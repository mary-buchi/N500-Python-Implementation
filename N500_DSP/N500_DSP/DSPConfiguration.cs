...
namespace N500_DSP
{
    internal static class DSPConfiguration
    {
        ...
        public static int MinRawDataSize => 4 * (FullScan ? UsefulPointsFullScan : UsefulPointsHalfScan);
    ...
    internal static class DspFilters
    {
        // Laser filter
